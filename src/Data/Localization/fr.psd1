...
# Please submit PRs for corrections or additional translations.
...
@{
    UIStrings = @{
        ...
        Errors = @{
            WindowsOnly         = 'ShowTree ne prend actuellement en charge que Windows pour le mode Tree.'
            ...
            InvalidAttribute    = "L'attribut du profil de style '{0}' n'est pas une valeur System.IO.FileAttributes valide."
        }
    }
}
